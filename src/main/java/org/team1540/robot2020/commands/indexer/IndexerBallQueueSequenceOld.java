...
public class IndexerBallQueueSequenceOld extends SequentialCommandGroup {
    public IndexerBallQueueSequenceOld(Indexer indexer, Funnel funnel) {
                                ...
                                race(
                                        ...
                                        sequence(
                                                ...
                                                new InstantCommand(() -> {
                                                    ...
                                                    new IndexerBallQueueSequenceOld(indexer, funnel).schedule();
                                                })
                                        )
                                )
                        ),
