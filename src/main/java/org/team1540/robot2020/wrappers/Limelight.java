package org.team1540.robot2020.wrappers;
...
public class Limelight {
    ...
    public Limelight(String name, double limelightHeight, double limelightAngle) {
        limelightTable = NetworkTableInstance.getDefault().getTable(name);
        this.limelightHeight = limelightHeight;
        this.limelightAngle = limelightAngle;
    }

    public Limelight(String name, double limelightHeight, double limelightAngle, double targetHeight) {
        limelightTable = NetworkTableInstance.getDefault().getTable(name);
        this.limelightHeight = limelightHeight;
        this.limelightAngle = limelightAngle;
