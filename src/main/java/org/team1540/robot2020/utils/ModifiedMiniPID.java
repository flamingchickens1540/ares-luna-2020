...
public class ModifiedMiniPID {
     ...
     */
    public ModifiedMiniPID(double p, double i, double d) {
        P = p;
        I = i;
        D = d;
        checkSigns();
     ...
     */
    public ModifiedMiniPID(double p, double i, double d, double f) {
        P = p;
        I = i;
        D = d;
        F = f;
    ...
    public double getOutput(double actual, double setpoint) {
        ...
        output = Foutput + Poutput + Ioutput + Doutput + Math.copySign(C, error);
